...
- `references/api-pitfalls.md` — Verified endpoints, invalid endpoints, shell escaping issues, "shared KB" not supported, error codes
- `notes/references/api.md` — Notes API full reference
- `knowledge-base/references/api.md` — Knowledge base API full reference
